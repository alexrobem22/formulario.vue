        ...
        <div class="row">
            <div class="col-6 bg-light">
                ...
                <!-- <form @reset.prevent="resetar()"> -->
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <div class="form-check form-switch">
                                <!-- USO TRUE-VALUE PARA DEFINIR UM VALOR QUANDO ELE FOR TRUE E -->
                                <!-- USO FALSE-VALUE PARA DEFINIR UM VALOR QUANDO ELE FOR FALSE -->
                                <input 
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" v-model="form.telefone" v-maska data-maska="(##) #####-####">
                            <small class="text-muted">Formato: 11 97777-5555</small>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label class="col-3 col-form-label">CPE:</label>
                        <div class="col">
                            <input type="text" class="form-control" v-model="form.cep" v-maska data-maska="#####-###">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" v-model="form.cpf" v-maska data-maska="###.###.###-##">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" v-model="form.cnpj" v-maska data-maska="##.###.###/####-##">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" v-model="form.cartaoDeCredito" v-maska data-maska="#### #### #### ####">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" v-model="form.placaVeiculo" v-maska data-maska="@@@-####">
                            <small class="text-muted">Formato: AAA-0000</small>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label class="col-3 col-form-label">Placa Veiculo Marcasul:</label>
                        <div class="col">
                            <input type="text" class="form-control" v-model="form.placaVeiculoMercosul" v-maska data-maska="@@@-#@##">
                            <small class="text-muted">Formato: AAA-0A00</small>
                        </div>
                    </div>
                    <!-- nao conseguir fazer usandoa  versao 2.1.6 mas na 1.5.1 e mas facil -->
                    <!-- <div class="mb-3 row">
                        <label class="col-3 col-form-label">Rg:</label>
                        <div class="col">
                            <input type="text" class="form-control" v-model="form.rg" v-maska data-maska="" data-maska-tokens="">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <!-- aqui vou de 0 ate 100 e o step e informando como ele anda de 1 ou de 5 em 5 ou bota 10 ele vai de 10 em 10  -->
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input :type="(form.alcance >= 50) ? 'text' : 'hidden'" class="form-control" v-model="form.escondido">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label class="col-3 col-form-label">Upload:</label>
                        <div class="col">
                            <!-- se eu  passar o => multiple eu posso adicionar varios arquivos se eu nao passar so consigo adicionar 1 por vez  -->
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <textarea class="form-control" name="" id="" cols="30" rows="3" v-model="form.descricao"></textarea>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label class="col-3 col-form-label">Curso:</label>
                        <div class="col">
                            <select name="curso" id="" class="form-select" v-model="form.curso">
                                <option value="" disabled>-- Selecione um opção</option>
                                <option :value="curso.id" v-for="(curso) in cursos" :key="curso.id">{{curso.id}} - {{curso.curso}}</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <!-- aqui eu pego o evento la do InputEstrelas -->
                            <!-- <input-estrelas :numero-estrelas="5" @avaliar="form.avaliacao = $event"/> -->
                            <!-- aqui eu o v-model fica escultando o evento update ai uso o v-model uso o nome do evendo e depois passo o form para enserir o dados nele -->
                    ...
                    <div class="mb-3 row">
                        <div class="col d-flex justify-content-between">
                            ...
                            <!-- aqui no click nao preciso passar nada no form so vou no meu metodo e pego o objeto e se eu quise nem preciso usar o form porque
                            to pegando os meus input pelo this.form -->
                            <button class="btn btn-success" type="button" @click="enviar($event)">Enviar (btn)</button>
                            <!-- submit eu pego ele no <form @submit.prevent="enviar($event)"> -->
            ...
            <div class="col-6 text-white bg-secondary" :style="'background-color:'+form.cor+' !important'">
                ...
                <div class="mb-3 row">
                    ...
                    <ul>
                        <li v-for="(interesse, index) in form.interesses" :key="index"> {{interesse}} {{index}}</li>
                    </ul>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    <span>Catão de Credito: {{form.cartaoDeCredito}}</span>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    <span>Descrição:</span>
                    <!-- usando o <pre></pre> eu presevor a quebra de linha dado dentro do textarea assim e mostrado em tela -->
                    <!-- <pre>{{form.descricao}}</pre> -->
                    <!-- outra forma e passando dentro de uma div e dando o estylo white-space: pre  -->
...
export default {
    ...
    methods:{
        ...
        enviar(e){
            ...
            // um modo mas seguro de enviar dados e criando uma copia dos dados ai nos usar essa propriedade => Object.assign({}, this.form)
            // ai mandamos para uma variavel e com enviamos os dados
